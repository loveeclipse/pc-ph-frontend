...
interface PatientPreHApi {
    ...
    fun putPatientAnagraphic(
        ...
        @Body anagraphicData: AnagraphicData
    ): Call<Void>
    ...
    fun postPacingManeuver(
        @Path("patientId") patientId: String,
        @Body pacingManeuver: PacingManeuver
    ): Call<Void>
    ...
    fun postTimedTreatment(
        @Path("patientId") patientId: String,
        @Body timedTreatment: TimedTreatment
    ): Call<String>

    @PATCH("/patients/{patientId}/treatments/timed/{treatmentId}")
    fun updateTimedTreatment(
        @Path("patientId") patientId: String,
