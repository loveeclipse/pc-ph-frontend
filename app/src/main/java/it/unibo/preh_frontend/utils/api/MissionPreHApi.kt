...
interface MissionPreHApi {
    ...
    fun insertChosenHospital(
        @Path("eventId") eventId: String,
        @Path("missionId") missionId: String,
        @Body chosenHospital: String
    ): Call<Void>
